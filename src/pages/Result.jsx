...
//           <span className={`absolute bottom-0 left-0 h1 bg-blue-500
...
//      {!isImageLoaded && 
//      <div className='flex w-full max-w-xl bg-neutral-500 text-sm text-white p-0.5 mt-10 rounded-full'>
...
//       <a href={image} download className='bg-zinc-900 rounded-full cursor-pointer px-10 py-3'>
//         Download
//       </a>
//      </div>
//       }
