...
const Header = ()=>{
    ...
    return(
        ...
        viewport={{once:true}}>
            ...
            <motion.h1 className="text-4xl max-w-[300px sm:text-7xl sm:max-w-590] mx-auto mt-10 text-center">
                Turn text to <span className="text-blue-700"
                initial={{opacity:0}}
                animate={{opacity:1}}
            ...
            <motion.p className="text-center max-w-xl mx-auto mt-5"
                ...
                -just type, and see the magic happening.
            </motion.p>
            <motion.button onClick={onClickHandler}
             className="flex sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5
